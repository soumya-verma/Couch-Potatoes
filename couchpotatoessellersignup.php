...
<html>
<head>
	<link rel="stylesheet" type="text/css" href="sellersignupstyle.css">
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
	<title>Couch Potatoes Seller Signup</title>
</head>
<?php
...
<script type="text/javascript">
	...
	function validate5()
	{
		var g=document.myform.gst.value;
		if(g=="")
		{
			document.getElementById("gstErr").innerHTML="Gst number is required!!!";
			return false;
		}
		else if(g.match(/[A-Z]/g) && y.match(/[0-9]/g) && g.length==15)
			return true;
		else
		{
			document.getElementById("gstErr").innerHTML="Enter a valid gst number!!!";
			return false;
		}
	}
</script>
	...
	<div class="bgimage">
		...
		<div class="div">
			<form class="form" name="myform">
				<p class="al">SELLER SIGNUP</p>
				<p class="field">USERNAME <span class="error" id="nameErr">*</span></p>
				<input class="text" type="text" name="username">
				<p class="field">GST NUMBER <span class="error" id="gstErr">*</span></p>
				<input class="text" type="text" name="gst">
				...
				<p class="field">COMPANY NAME <span class="error" id="compErr">*</span></p>
				...
				<div class="login">
					<button class="loginbut" onclick="return validate3()" formaction="couchpotatoessellerlogin.html">Signup</button>
				</div>
			</form>
		</div>
	    </div>
